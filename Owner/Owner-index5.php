 ...
 <!-- Table Head States -->
    <div class="card card-default">
      <div class="card-header">
        <center><h1 style="color:pink;font-style:italic;margin-top:50px;">Update Property</h1></center>
         ...
         <div class="container-xxl" id="menu1" display="none">
          ...
          <tbody> 
				...
				while($rw1=mysqli_fetch_row($res1))
				{
					...
					<td><a href='Owner-index6.php?id=<?php echo $rw1[0];?>'><button type="submit" name="btn_update" class="btn" style="background-color:yellow">Update</button></a></td>
					<td><a href='Owner-index7.php?id=<?php echo $rw1[0];?>'><button type="submit" name="btn_delete" class="btn" style="background-color:red">Delete</button></a></td>
					</tr>
					<?php
				}
				?>
