 ...
 <!-- Table Head States -->
    <div class="container-xxl">
      <div class="card-header">
        <center><h1 style="color:Tan;font-style:italic;margin-top:50px">Tenant Details</h1></center>
      ...
      <div class="card-body">
         <div class="container-xxl bg-white" id="menu1" display="none">
          ...
          <tbody> 
				...
				$sql1="select * from register where user_type='tenant'";
				...
				while($rw1=mysqli_fetch_row($res1))
				{
					...
					<td><img src="../Login/image/<?php echo $rw1[1]; ?>" height="100px" width="100px" style="margin-top:20px;border-radius:20px">
					</td>
