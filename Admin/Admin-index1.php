 ...
 <!-- Table Head States -->
    <div class="container-xxl">
      <div class="card-header">
        <center><h1 style="color:pink;font-style:italic;margin-top:50px;">Property List</h1></center>
         ...
         <div class="container-xxl" id="menu1" display="none">
          ...
          <tbody> 
				...
				while($rw1=mysqli_fetch_row($res1))
				{
					...
					<td><img src="../Owner/image/<?php echo $rw1[1]; ?>" height="100px" width="100px" style="margin-top:20px;border-radius:20px">
					</td>
